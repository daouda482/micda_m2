...
class CandidatureController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('recruteur.candidatures.index', compact('candidatures'));
    }
    ...
    public function accept($id)
    {
        ...
        return redirect()->route('recruteur.candidatures.index')->with('success', 'Candidature acceptée et mail envoyé.');
    }
    ...
    public function reject($id)
    {
        ...
        return redirect()->route('recruteur.candidatures.index')->with('success', 'Candidature rejetée et mail envoyé.');
    }
    ...
    public function planifierEntretien(Request $request, $id)
    {
        ...
        return redirect()->route('recruteur.candidatures.index')->with('success', 'Entretien planifié avec succès.');
    }
}
