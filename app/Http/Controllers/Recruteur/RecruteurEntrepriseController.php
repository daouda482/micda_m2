...
class RecruteurEntrepriseController extends Controller
{
    /**
    ...
    {
        return view('recruteur.entreprises.create');
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('recruteur.entreprises.index')
    ...
    public function show(string $id)
    {
        ...
        return view('recruteur.entreprises.show', compact('entreprise'));
    }
    ...
    {
        return view('recruteur.entreprises.edit', compact('entreprise'));
    }
