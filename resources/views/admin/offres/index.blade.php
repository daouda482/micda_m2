            ...
            <tbody>
                @forelse ($offres as $offre)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.offres.show', $offre->id) }}" class="btn btn-sm btn-success" title="Voir">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.offres.edit', $offre->id) }}" class="btn btn-sm btn-warning" title="Modifier">
