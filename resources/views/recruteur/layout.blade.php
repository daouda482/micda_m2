...
<head>
    ...
    <style>
        ...
        .sidebar {
            ...
            padding-top: 20px;
            position: fixed;
            top: 65px; /* décalage à cause du header */
            left: 0;
            width: 220px;
        }
        .sidebar a {
        ...
        .content {
            margin-left: 220px; /* espace pour sidebar */
            margin-top: 80px; /* espace pour header */
            padding: 20px;
        }
        .card {
            border: none;
...
<!-- HEADER -->
<div class="header">
    <h4><i class="fas fa-briefcase"></i> Tableau de Bord Recruteur</h4>
    <div class="user-info">
        <span><i class="fas fa-user-circle"></i> Recruteur</span>
