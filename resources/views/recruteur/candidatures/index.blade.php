                    ...
                    @forelse($candidatures as $candidature)
                        <tr>
                            ...
                            <td>
                                @if ($candidature->statut === 'en attente')
                                    {{-- Bouton accepter --}}
                                    <form action="{{ route('recruteur.candidatures.accept', $candidature->id) }}"
                                    ...
                                    {{-- Bouton rejeter --}}
                                    <form action="{{ route('recruteur.candidatures.reject', $candidature->id) }}"
                                        method="POST" class="d-inline"
                                    ...
                                    <a href="{{ route('recruteur.candidatures.show', $candidature->id) }}"
                                ...
                                @elseif($candidature->statut === 'accepte')
                                    ...
                                    <a href="{{ route('recruteur.entretiens.planifier', $candidature->id) }}"
